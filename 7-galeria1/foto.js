...
class PhotoSlider {
    constructor(options = {}) {
        ...
        this.imageDisplayMode = options.imageDisplayMode || 'contain'; // tryb wyświetlania: 'contain' (dopasowanie) lub 'cover' (wyśrodkowanie)
    ...
    /**
     * Ustawienie trybu wyświetlania zdjęcia
     */
    setImageDisplayMode(mode) {
        if (['contain', 'cover'].includes(mode)) {
            this.imageDisplayMode = mode;
            this.applyBackgroundColor(); // Ponowne zastosowanie stylu
            console.log(`Zmieniono tryb wyświetlania na: ${mode}`);
        } else {
            console.warn('Nieprawidłowy tryb wyświetlania. Dostępne opcje: contain, cover');
        }
    }
    ...
    applyBackgroundColor() {
        if (this.container) {
            ...
            if (photoDisplay) {
                ...
                // Zastosowanie trybu wyświetlania zdjęcia
                photoDisplay.style.backgroundSize = this.imageDisplayMode;
            }
        }
    }
    ...
    getConfig() {
        return {
            ...
            imageDisplayMode: this.imageDisplayMode,
